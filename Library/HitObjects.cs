...
namespace OsuLoader {
    ...
    public struct HitCircle : IHitObject {
        public HitObjectType GetHitObjType() => HitObjectType.HitCircle;
    ...
    public struct Slider : IHitObject {
        public HitObjectType GetHitObjType() => HitObjectType.Slider;
        public int X { get; set; }
        public int Y { get; set; }
        public int Time { get; set; }
        public HitSoundType HitSound { get; set; }
    ...
    public struct Spinner : IHitObject {
        public HitObjectType GetHitObjType() => HitObjectType.Spinner;
        public int X { get; set; }
        public int Y { get; set; }
        public int Time { get; set; }
        public HitSoundType HitSound { get; set; }
    ...
    public struct ManiaHold : IHitObject {
        public HitObjectType GetHitObjType() => HitObjectType.ManiaHold;
        public int X { get; set; }
        public int Y { get; set; }
        public int Time { get; set; }
        public HitSoundType HitSound { get; set; }
